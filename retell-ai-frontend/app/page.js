  ...
  const startCall = async () => {
    try {
      ...
      const response = await fetch(
        `https://localhost:3001/create-web-call?t=${Date.now()}`,
        {
          method: "POST",
          headers: {
          ...
          >
            <div
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, #00f7ff, #ff6bcb, #ff4757)",
                borderRadius: "50%",
                position: "relative",
                  ...
                  {transcript.split("\n\n").map((line, index) => (
                    <div
                      ...
                      style={{
                        ...
                        alignSelf: line.startsWith("👩 Emma")
                          ? "flex-start"
                          : "flex-end",
